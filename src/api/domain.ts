...
const noneableNumber = z
    .union([z.string(), z.number()])
    .transform((x) => (x === "None" ? undefined : Number(x)))
    .nullable();
...
export const elementSchema = z.object({
    ...
    creativity: stringOrNumberAsNumber,
    goals_conceded: z.number(),
    goals_scored: z.number(),
    ict_index: stringOrNumberAsNumber,
    influence: stringOrNumberAsNumber,
    minutes: z.number(),
    own_goals: z.number(),
    ...
    red_cards: z.number(),
    saves: z.number(),
    threat: stringOrNumberAsNumber,
    yellow_cards: z.number(),
    starts: z.number().optional(),
    expected_goals: stringOrNumberAsNumber.optional(),
    expected_assists: stringOrNumberAsNumber.optional(),
    expected_goal_involvements: stringOrNumberAsNumber.optional(),
    expected_goals_conceded: stringOrNumberAsNumber.optional(),
    added: z.string().optional(),
    chance_of_playing_next_round: noneableNumber,
    chance_of_playing_this_round: noneableNumber,
    code: z.number(),
    draft_rank: z.number().optional(),
    dreamteam_count: z.number(),
    ep_next: stringOrNumberAsNumber.nullable(),
    ep_this: stringOrNumberAsNumber.nullable(),
    event_points: z.number(),
    first_name: z.string(),
    form: stringOrNumberAsNumber,
    ...
    points_per_game: stringOrNumberAsNumber,
    second_name: z.string(),
    squad_number: noneableNumber,
    status: z.string(),
    ...
    points_per_game_rank_type: stringOrNumberAsNumber.nullable().optional(),
    corners_and_indirect_freekicks_order: noneableNumber,
    corners_and_indirect_freekicks_text: z.string().nullable(),
    direct_freekicks_order: noneableNumber,
    direct_freekicks_text: z.string().nullable(),
    penalties_order: noneableNumber,
...
export const settingsSchema = z.object({
    ...
    squad: z.object({
        ...
        position_type_locks: z.record(z.string(), z.string()),
