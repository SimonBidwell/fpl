    ...
    <Card className="w-64 flex-shrink-0">
      <CardBody className="flex flex-col gap-2 p-2">
        ...
        >
          ...
          <div>
            <div className="font-bold w-1/2" style={{ wordSpacing: "100vw" }}>
              {displayName}
            </div>
              ...
              {Object.keys(fixtures)
                ...
                .map((gameweek) => (
                  <div className="flex flex-col items-center text-xs px-2">
                    <div className="flex">
                      {fixtures[gameweek].map(({ opposition }) => (
                        <img
        ...
        <div className="grid gap-2 grid-cols-4">
          ...
          <Section title="xG + xA">{expected_goal_involvements}</Section>
        </div>
