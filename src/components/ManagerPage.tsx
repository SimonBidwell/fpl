  ...
  return (
    <div className="flex flex-col gap-4">
        ...
        <CardBody className="flex flex-row justify-between">
          ...
          <div className="flex gap-4">
            <div className="flex flex-col items-center">
              ...
              <div className="text-2xl text-bold">{played.length}</div>
            </div>
            <div className="flex flex-col items-center">
              <div className="text-xs">Wins</div>
              <div className="text-2xl text-bold">{wins.length}</div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-2xl text-bold">{draws.length}</div>
              <div className="text-tiny text-foreground-400">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-2xl text-bold">{losses.length}</div>
      ...
      <StandingsTable
        ...
        topContent={
          <div className="text-xl font-semibold">Historical performance</div>
        }
      ...
      <RecordsTable
        records={recordRows}
        topContent={<div className="text-xl font-semibold">Head to head</div>}
      />
    </div>
  );
};
