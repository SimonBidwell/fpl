...
const COLUMNS: Column[] = [
  ...
  },
  {
    ...
    sort: (a, b) =>
      a.losses.length / a.played.length - b.losses.length / b.played.length,
  },
  {
      ...
      return (
        <div className="flex gap-[0.1rem]">
          {mostRecent.map((match, i) => {
            ...
            if (alignment) {
              const { team: opposition, opposition: team } = alignment;
              return (
                <Tooltip
                  delay={600}
                  key={i}
                  content={
                    <div className="flex flex-col p-1">
                      <div className="text-tiny uppercase font-medium text-foreground-400 pb-1">
                        {match.season} - Gameweek {match.gameWeek}
                      </div>
                ...
                >
                  <div>
                    <Result result={Match.resultForTeam(match, team.id)} />
                  </div>
                </Tooltip>
              );
            } else {
